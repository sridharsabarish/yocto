...
* Identifying licenses used by any recipe.
...
  <details>
	...
	`~/git/poky/build/tmp/deploy/license` contains licensing information for all the packages!
   </details>
...
  <details>
	   <summary>Answer</summary>
	- ~/git/poky/meta/files/common-licenses
