...
**Note: There is a corrupt package during the VM creation. Please clean it using `bitbake -c cleanall tictactoe` before running the package-index command below**
